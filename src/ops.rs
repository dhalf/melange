...
///
/// let a: StaticTensor<f64, Shape2D<U2, U2>> = Tensor::try_from(vec![1.0, FRAC_1_SQRT_2, FRAC_1_SQRT_2, 1.0]).unwrap();
...
///
/// let a: StaticTensor<f64, Shape2D<U2, U2>> = Tensor::try_from(vec![LN_2, 0.0, 0.0, LN_2]).unwrap();
...
/// use std::f64::consts::E;
///
/// let a: StaticTensor<f64, Shape2D<U2, U2>> = Tensor::try_from(vec![E, 1.0, 1.0, E]).unwrap();
/// let b: StaticTensor<f64, Shape2D<U2, U2>> = Tensor::try_from(vec![1.0, 0.0, 0.0, 1.0]).unwrap();
/// assert_eq!(a.ln(), b);
/// ```
pub trait Ln {
...
/// use std::f64::consts::E;
///
/// let a: StaticTensor<f64, Shape2D<U2, U2>> = Tensor::try_from(vec![0.0, E - 1.0, E - 1.0, 0.0]).unwrap();
...
/// use std::f64::consts::E;
///
/// let a: StaticTensor<f64, Shape2D<U2, U2>> = Tensor::try_from(vec![256.0, 1_024.0, 1_024.0, 256.0]).unwrap();
...
/// use std::f64::consts::E;
///
/// let a: StaticTensor<f64, Shape2D<U2, U2>> = Tensor::try_from(vec![100.0, 1_000.0, 1_000.0, 100.0]).unwrap();
...
///
/// let a: StaticTensor<f64, Shape2D<U2, U2>> = Tensor::try_from(vec![0.0, FRAC_PI_6, FRAC_PI_4, FRAC_PI_2]).unwrap();
...
///
/// let a: StaticTensor<f64, Shape2D<U2, U2>> = Tensor::try_from(vec![0.0, FRAC_PI_4, FRAC_PI_3, FRAC_PI_2]).unwrap();
...
///
/// let a: StaticTensor<f64, Shape2D<U2, U2>> = Tensor::try_from(vec![-FRAC_PI_4, 0.0, FRAC_PI_4, 0.0]).unwrap();
/// let b: StaticTensor<f64, Shape2D<U2, U2>> = Tensor::try_from(vec![-1.0, 0.0, 1.0, 0.0]).unwrap();
...
/// use std::f64::consts::{FRAC_PI_6, FRAC_PI_4, FRAC_PI_2, FRAC_1_SQRT_2};
///
/// let a: StaticTensor<f64, Shape2D<U2, U2>> = Tensor::try_from(vec![0.0, 0.5, FRAC_1_SQRT_2, 1.0]).unwrap();
...
/// use std::f64::consts::{FRAC_PI_4, FRAC_PI_3, FRAC_PI_2, FRAC_1_SQRT_2};
///
/// let a: StaticTensor<f64, Shape2D<U2, U2>> = Tensor::try_from(vec![1.0, FRAC_1_SQRT_2, 0.5, 0.0]).unwrap();
...
///
/// let g = ((E * E) - 1.0) / (2.0 * E);
/// let a: StaticTensor<f64, Shape2D<U2, U2>> = Tensor::try_from(vec![g, 0.0, 0.0, g]).unwrap();
/// let b: StaticTensor<f64, Shape2D<U2, U2>> = Tensor::try_from(vec![1.0, 0.0, 0.0, 1.0]).unwrap();
...
///
/// let g = ((E * E) + 1.0) / (2.0 * E);
/// let a: StaticTensor<f64, Shape2D<U2, U2>> = Tensor::try_from(vec![g, 1.0, 1.0, g]).unwrap();
/// let b: StaticTensor<f64, Shape2D<U2, U2>> = Tensor::try_from(vec![1.0, 0.0, 0.0, 1.0]).unwrap();
...
///
/// let a: StaticTensor<f64, Shape2D<U2, U2>> = Tensor::try_from(vec![FRAC_PI_6, FRAC_PI_4, FRAC_PI_3, FRAC_PI_2]).unwrap();
...
/// use std::f64::consts::{FRAC_PI_6, FRAC_PI_4, FRAC_PI_3, FRAC_PI_2};
///
/// let a: StaticTensor<f64, Shape2D<U2, U2>> = Tensor::try_from(vec![30.0, 45.0, 60.0, 90.0]).unwrap();
...
/// use num_complex::{Complex, Complex64};
///
/// let mut a: StaticTensor<Complex64, Shape2D<U2, U2>> = Tensor::try_from(vec![
///     Complex::new(1.0, 0.0), Complex::new(0.0, 1.0),
///     Complex::new(-1.0, 0.0), Complex::new(0.0, -1.0)
/// ]).unwrap();
/// let b: StaticTensor<Complex64, Shape2D<U2, U2>> = Tensor::try_from(vec![
